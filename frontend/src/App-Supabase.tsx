...
import DataFlowDebugPage from './pages/DataFlowDebugPage';
    ...
    <SupabaseAuthProvider>
      <Router>
        ...
        <Routes>
          ...
          <Route path="/debug-simple" element={<SimpleDebugPage />} />
          ...
          {/* Debug Pages - Protected but doesn't require onboarding */}
